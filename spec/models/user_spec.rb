...
RSpec.describe User, type: :model do
  ...
  describe "callbacks" do
    ...
    describe "after initialize" do
      ...
      it "should receive :set_default_options" do
        expect_any_instance_of(User).to receive(:set_default_options)
      end
    end
  ...
  describe "#set_default_options" do
    ...
    it "sets auto_generate_profile_picture to true" do
      user.send(:set_default_options)
      expect(user.options[:auto_generate_profile_picture]).to be true
    end
  end
